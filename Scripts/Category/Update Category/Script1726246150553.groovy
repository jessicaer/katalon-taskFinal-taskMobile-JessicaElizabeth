...
Mobile.tap(findTestObject('Object Repository/page_Category/android.widget.btn_Edit'), 0)

Mobile.setText(findTestObject('Object Repository/page_Category/android.widget.EditText - Personal'), updateCategory, 
    0)

Mobile.tap(findTestObject('Object Repository/page_Category/android.widget.btn_Update'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/page_Category/android.widget.lbl_Category'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/page_Category/android.widget.TextView - Diri Sendiri'), 
    updateCategory)
