...
Mobile.setText(findTestObject('Object Repository/Record/Object Add Task/android.widget.EditText - Enter task title'), 'Katalon Class', 
    0)

Mobile.setText(findTestObject('Object Repository/Record/Object Add Task/android.widget.EditText - Enter your task'), 'Mobile, API', 
    0)
